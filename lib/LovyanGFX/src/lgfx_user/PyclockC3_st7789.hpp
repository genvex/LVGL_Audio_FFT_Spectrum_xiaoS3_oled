...
*/
      ...
      cfg.pin_sclk = 6;            // 设置 SPI 的 sclk 引脚编号
      cfg.pin_mosi = 7;            // 设定 SPI 的 mosi 引脚编号
      cfg.pin_miso = -1;            // 设置SPI的MISO引脚编号(-1=disable)
      cfg.pin_dc   = 4;            // 设置SPI的D/C引脚编号(-1 = disable)
...
*/
    ...
    { // 进行显示面板控制的设置。
      ...
      cfg.pin_cs           =    5;  // CS连接的引脚编号(-1=disable)
      cfg.pin_rst          =    8;  // RST连接的引脚编号(-1=disable)
